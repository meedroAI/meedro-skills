...
- Installed version: 1.32.0. Call check_for_plugin_updates for the latest; if newer, tell them to re-download from the Meedro dashboard (Connect to Claude -> Download the plugin) and re-upload it in Claude. If equal, they are up to date.
